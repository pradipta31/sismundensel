...
class BayiController extends Controller
{
    public function tambahBayi(){
        ...
        return view('kepmas.bayi.tambah-bayi', compact('puskesmas'));
    }
   ...
   public function simpanBayi(Request $r){
        ...
        if(!$validator->fails()){
            if ($r->status == 'hidup') {
                if($check == null){
                    ...
                    return redirect(url('kepmas/bayi/data-bayi'));
                }else{
       ...
       public function dataBayi(){
        ...
        return view('kepmas.bayi.data-bayi', compact('bayi','users'));
    }

        public function editBayi($id){
        $bayi= Bayi::findOrFail($id);
        return view('kepmas.bayi.edit-bayi', compact('bayi'));
    }
