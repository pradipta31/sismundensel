...
class PasienController extends Controller
{
    public function tambahPasien(){
        ...
        return view('admin.pasien.tambah-pasien', compact('puskesmas'));
    }
    public function simpanPasien(Request $r){
        ...
        return redirect(url('admin/pasien/data-pasien'));
    }else{
	    ...
	    return view('admin.pasien.data-pasien', compact('pasien','users'));
	}
        public function editPasien($id){
        $pasien= Pasien::findOrFail($id);
        return view('admin.pasien.edit-pasien', compact('pasien'));
    }
