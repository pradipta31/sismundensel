		...
		<div class="container-fluid">
          ...
          @endif
	        ...
	        <div class="card-body">
	            ...
	            <a href="{{url('kepmas/imunisasi/cetak-imunisasi/'.$tgl_imunisasi.'/'.$jenis)}}" class="btn btn-primary">Cetak Data</a>
							<hr>
								...
								<div class="row">
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="date" name="tgl_imunisasi" class="form-control" value="{{$tgl_imunisasi}}">
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											<label for="">Pilih Jenis Imunisasi</label>
											<select class="form-control" name="jenis_imunisasi" value="{{$jenis}}">
											<option value="hepatitis_b_0" {{$jenis == 'hepatitis_b_0' ? 'selected' : ''}}>Hepatitis B 0</option>
											<option value="polio_1" {{$jenis == 'polio_1' ? 'selected' : ''}}>Polio 1</option>
											<option value="polio_2" {{$jenis == 'polio_2' ? 'selected' : ''}}>Polio 2</option>
											<option value="polio_3" {{$jenis == 'polio_3' ? 'selected' : ''}}>Polio 3</option>
											<option value="polio_4" {{$jenis == 'polio_4' ? 'selected' : ''}}>Polio 4</option>
											<option value="ipv" {{$jenis == 'ipv' ? 'selected' : ''}}> IPV</option>
										  	<option value="bcg" {{$jenis == 'bcg' ? 'selected' : ''}}> BCG</option>
										  	<option value="dpthb_1" {{$jenis == 'dpthb_1' ? 'selected' : ''}}>DPT/HB 1</option>
										 	<option value="dpthb_2" {{$jenis == 'dpthb_2' ? 'selected' : ''}}>DPT/HB 2</option>
										   	<option value="dpthb_3" {{$jenis == 'dpthb_1' ? 'selected' : ''}}>DPT/HB 3</option>
										   	<option value="campak_rubela" {{$jenis == 'campak_rubela' ? 'selected' : ''}}>Campak-Rubela</option>
										   	<option value="je" {{$jenis == 'je' ? 'selected' : ''}}>JE</option>
										</select>
										</div>
									</div>
										<div class="col-lg-4">
										...
										<a href="{{url('kepmas/imunisasi/data-imunisasi')}}" class="btn btn-success" style="margin-top: 30px"> <i class="fa fa-refresh"></i> Refresh</a>
									</div>
								</div>
							</div>
						</form>
