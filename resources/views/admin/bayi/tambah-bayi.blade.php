        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                        <h4 class="card-title">Tambah Bayi</h4>
                        <form class="form p-t-20" action="{{url('admin/bayi/tambah-bayi')}}" 
                        method="post">
                            {{csrf_field()}}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="nama_bayi" class="form-control" id="exampleInputuname" placeholder="Nama Bayi">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="date" name="tgl_kematian" class="form-control" id="exampleInputEmail1">
...
@endsection <small>Masukkan Tanggal Kematian Apabila Bayi Meninggal</small>