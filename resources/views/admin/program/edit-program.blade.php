            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <form class="form p-t-20" action="{{url('admin/program/'.$programsekolah->id.'/edit-program')}}" method="post">
                            {{csrf_field()}}
                            ...
                            <a href="{{url('admin/program/data-program')}}" class="btn btn-info">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
