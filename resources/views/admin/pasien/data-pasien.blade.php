                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{url('admin/pasien/cetak-pasien/'.$users->id)}}" class="btn btn-primary">Cetak Data</a>
		                        ...
		                        @foreach($pasien as $p)
		                        	<tr>
			                            ...
			                            <td style="text-align: center;">
			                            	...
			                            	<a href="{{url('admin/pasien/'.$p->id.'/edit-pasien')}}" class="btn btn-warning">Edit</a>
											<!-- Modal -->
											  ...
											  <div class="modal-dialog modal-dialog-scrollable" role="document">
											    <div class="modal-content">
											      ...
											      <div class="modal-footer">
											        <a href="{{url('admin/pasien/data-pasien')}}" class="btn btn-default">Close</a>
											      </div>
											    </div>
											  </div>
											</div>
